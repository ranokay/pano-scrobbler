...
final class AppModel: ObservableObject {
    ...
    private lazy var discordRPC: DiscordRichPresence = {
        // Default Discord application ID for Pano Scrobbler
        // Users can register their own at discord.com/developers
        DiscordRichPresence(clientId: "1100000000000000000")
    }()
